...
,265,265,235,265,265,87,87,87,187])) #range of EV in miles
  ...
  #E_i= E_abs*(SOC_i+residue) #Initial Energy of Battery Pack at time t, KWh
  E_i= E_abs*(SOC_i) #Initial Energy of Battery Pack at time t, KWh

  t=d/v #time taken to pass the road segment, h
  P_cons=k*v #Power consumed in the process, KW
  E_cons=P_cons*t #Energy consumed in the process, KWh
